...
<head>
    ...
    <link href="<?php echo e(asset('css/index_style.css')); ?>" rel="stylesheet">
        ...
        <div class="col-md-4" ng-repeat="(name,val) in records" ng-click="setSelected($index)">
            <div id="closeablecard"
                ...
                <div class="card-body mt-n5">
                    <div class="row">
                        <div class="col-md-4">
                            <img class="flag" src="<?php echo e(asset('')); ?>{{val.image_path}}">{{ val.symbol }}
                        </div>
                        <div class="col-md-8">
...
<?php /**PATH C:\xampp\htdocs\Projects\Laravel\resources\views/home/index.blade.php ENDPATH**/ ?>